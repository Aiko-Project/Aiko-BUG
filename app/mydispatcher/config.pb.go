...
var file_app_mydispatcher_config_proto_goTypes = []interface{}{
	(*SessionConfig)(nil), // 0: Aiko.app.mydispatcher.SessionConfig
	(*Config)(nil),        // 1: Aiko.app.mydispatcher.Config
}
var file_app_mydispatcher_config_proto_depIdxs = []int32{
	0, // 0: Aiko.app.mydispatcher.Config.settings:type_name -> Aiko.app.mydispatcher.SessionConfig
